...
class TaskService:
    ...
    def run_task(case_path, module_instance: OsirModuleModel, task, queue, case_uuid):
        ...
        task_signature = signature(TaskService.get_task_name(module_instance), args=(module_instance.input._match, case_path, module_instance.model_dump_json(), case_uuid), immutable=True, queue=TaskService.get_queue_name(module_instance))
