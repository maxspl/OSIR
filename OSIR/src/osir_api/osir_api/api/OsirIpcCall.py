...
from osir_api.api.OsirApiExceptions import HTTPExceptionCustom, UnexpectedException
...
def OsirIpcCall(action: str, params: Optional[dict] = {}, response_only: bool = False) -> Union[JSONResponse, dict]:
    ...
    Raises HTTPExceptionCustom or UnexpectedException on any error.
    ...
    try:
        ...
        raise HTTPExceptionCustom(status_code=e.status_code, error=str(e.detail))
