...
| all       | thor_orc_ram.yml                     | Scan of RAM restored file system from MemProcFS using Thor (requires Forensic license).                                                 |              |       1   | external              | thor/thor-linux-64                  |
...
| unix      | collect_info_uac.yml                 | Hash of DFIR UAC collected file                                                                                                         |              |       1   | external              | /usr/bin/find                       |
...
| windows   | collect_info_orc.yml                 | Hash of DFIR ORC collected file                                                                                                         |              |       1   | external              | /usr/bin/find                       |
...
| windows   | ps1_history.yml                      | Parse ConsoleHost_history.txt                                                                                                           | maxspl       |       1   | internal              |                                     |
...
| windows   | win_enunlocs.yml                     | Parse Enumlocs.txt from DFIR ORC                                                                                                        | maxspl       |       1   | internal              |                                     |
